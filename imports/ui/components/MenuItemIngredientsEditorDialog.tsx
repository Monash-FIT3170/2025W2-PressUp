...
const MenuItemIngredientsEditorDialog: React.FC<Props> = ({
  open,
  item,
  onClose,
}) => {
      ...
      prev.map((g) =>
        g.id === groupId
          ? {
              ...
              options: [
                ...g.options,
                { key: newKey, label: "", default: false, priceDelta: 0 },
              ],
            }
          : g,
      ),
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
      ...
      <DialogContent dividers>
        {/* === Base Ingredients === */}
        <div className="text-xl font-semibold text-red-900 dark:text-white">
          Base Ingredients
        </div>
        ...
        {baseIngredients.map((b) => (
          ...
          >
            ...
            <TextField
              ...
              onChange={(e) =>
                handleBaseChange(b.key, "priceDelta", Number(e.target.value))
              }
              size="small"
              sx={{ flex: "0 0 120px" }}
            />
            ...
            <Box display="flex" alignItems="center" gap={1}>
              ...
              >
                <span
                  className={`inline-block w-5 h-5 transform bg-white rounded-full transition-transform ${(b.removable ?? true) ? "translate-x-5" : "translate-x-1"}`}
                />
              </button>
            </Box>
            ...
            <Box display="flex" alignItems="center" gap={1}>
              ...
              >
                <span
                  className={`inline-block w-5 h-5 transform bg-white rounded-full transition-transform ${(b.default ?? false) ? "translate-x-5" : "translate-x-1"}`}
                />
              </button>
            </Box>
        ...
        {/* === Option Groups === */}
        <div className="text-xl font-semibold text-red-900 dark:text-white mb-2">
          Option Groups
        </div>
          ...
          >
            <Box display="flex" alignItems="center" gap={1.5} mb={1}>
              <TextField
                ...
                value={g.label}
                onChange={(e) =>
                  handleGroupChange(g.id, "label", e.target.value)
                }
                size="small"
                sx={{ flex: "1 1 40%" }}
              />
              ...
              <Box display="flex" alignItems="center" gap={1}>
                ...
                >
                  <span
                    className={`inline-block w-5 h-5 transform bg-white rounded-full transition-transform ${g.required ? "translate-x-5" : "translate-x-1"}`}
                  />
                </button>
              </Box>
            ...
            {g.options.map((o) => (
              ...
              >
                <TextField
                  value={o.label}
                  onChange={(e) =>
                    handleOptionChange(g.id, o.key, "label", e.target.value)
                  }
                  size="small"
                  sx={{ flex: "1 1 40%" }}
                />
                ...
                <Box display="flex" alignItems="center" gap={1}>
                  ...
                  <button
                    ...
                    className={`relative inline-flex items-center h-5 rounded-full w-10 transition-colors focus:outline-none focus:ring-2 focus:ring-press-up-purple ${o.default ? "bg-press-up-purple" : "bg-gray-300"}`}
                  >
                    <span
                      className={`inline-block w-4 h-4 transform bg-white rounded-full transition-transform ${o.default ? "translate-x-5" : "translate-x-1"}`}
                    />
                  </button>
                </Box>
                <div
