...
export const AllergenDropdown = ({
  ...
  useEffect(() => {
    setSearchAllergen("");
  }, [initialAllergens, selectedAllergen]);
          ...
          >
            {searchAllergenList.length > 0 ? (
              searchAllergenList.map((allergen) => (
                <li
                  key={allergen}
                  className="flex p-2 hover:bg-press-up-purple-200 rounded justify-between items-center"
                >
              ...
              <li className="p-2 text-sm text-press-up-purple-500">
                <button
                  ...
                  onClick={() => {
                    ...
                    if (trimInput !== "" && !allAllergens.includes(trimInput)) {
                      const newAllergen =
