    ...
    <div className="flex flex-1 flex-col">
      <div className="grid grid-cols-2">
        ...
        <button
          ...
          className="text-nowrap justify-self-end shadow-lg/20 ease-in-out transition-all duration-300 p-1 m-4 rounded-xl px-3 bg-press-up-purple text-white cursor-pointer w-24 right-2 hover:bg-rose-500"
        >
          Add Item
        </button>
      </div>
