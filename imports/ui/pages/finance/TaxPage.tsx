...
export const TaxPage = () => {
  ...
  const {
    ...
    const GSTItems = Object.entries(GSTByDate).map(([label, amount]) => ({
      label,
      amount,
    }));
    ...
    const expenseItems = Object.entries(expensesByDate).map(
  ...
  const deductionsTotal = useMemo(
    () => filteredDeductions.reduce((sum, d) => sum + Number(d.amount), 0),
    [filteredDeductions],
  );
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (mounted) {
        ...
        setPayrollItems(
          Object.entries(payByDate).map(([label, amount]) => ({
            label,
            amount,
          })),
        );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {(selectedMetric === "GSTCollected" ||
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-1">
                {financialData[selectedMetric].title}
              </h2>
              <p className="text-gray-600 mb-4">
                {financialData[selectedMetric].description}
              </p>
              <MemoBarChart
                data={financialData[selectedMetric].items}
                dataKeys={["amount"]}
                colors={["#6f597b"]}
              />
            </div>
          ...
          {selectedMetric === "payrollTax" && (
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                {financialData.payrollTax.description}
              </p>
              <MemoBarChart
          ...
          <div className="space-y-6">
            ...
            {(selectedMetric === "GSTCollected" ||
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Comparison of Goods and Services Tax Collected and Paid
                </p>
                <MemoBarChart
                  data={combinedItems}
                  dataKeys={["collected", "paid"]}
                  colors={["#6f597b", "#c6b6cf"]}
                />
              </div>
            )}
          </div>
