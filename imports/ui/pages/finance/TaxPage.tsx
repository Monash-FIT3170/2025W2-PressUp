...
export const TaxPage = () => {
  ...
  const chartTitle = selectedMetric
    ? currentData?.title
    : "GST Collected vs GST Paid";
  const chartDescription = selectedMetric
    ? currentData?.description
    : "Comparison of GST collected on sales and GST paid on expenses";
        ...
        <div className="bg-white md:w-3/5 rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            <div className="h-80 w-full">
              <ResponsiveContainer>
                <BarChart
                  data={currentData ? currentData.items : combinedItems}
                >
