...
Meteor.methods({
  "stockItems.insert": requireLoginMethod(async function (item: OmitDB<StockItem>) {
  ...
  "stockItems.update": requireLoginMethod(async function (itemId: IdType, updates: OmitDB<StockItem>) {
    check(itemId, String);
